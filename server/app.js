...
// Importando clase de conectora de mongoose
...
// creaando la instancia a la conexion de la DBS
const mongooseODM = new MongooseODM(configKeys.databaseUrl);
// Ejecutar la conexion a la base de datos
// crear una ambito async que me permita usar async await
(async () => {
  const connectionResult = mongooseODM.connect();
if(!connectionResult) winston.info(`❌ Error en la conexion`)
})();
